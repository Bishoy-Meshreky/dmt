  ...
  return (
    <div>
      ...
      <div className="min-h-screen bg-white">
        ...
        <section
          className="page-container page-boundaries relative w-full h-[600px] bg-white overflow-hidden"
        ...
        >
          <div className="relative h-full page-content">
            ...
            <a
              href="#"
              className="absolute left-[43px] top-[84px] w-[220px] h-[24px] flex items-center gap-2 text-black transition-colors hover:text-[#ECA22D]"
            >
              <span>←</span>
              <span className="font-sans text-base font-medium leading-6 whitespace-nowrap">
              ...
              <div className="absolute left-[42px] top-[25px] w-[700px] h-[46px] flex justify-between">
                <div className="flex items-center gap-3">
                  <div className="flex items-center justify-center w-[44px] h-[44px]">
                    <img
                      src="/src/assets/svg/clock-icon.svg"
                      alt="Duration"
                      className="w-10 h-10"
                    />
                  </div>
                  <div>
                    <p className="font-['Poppins'] font-light text-[14px] leading-[21px] text-white">
                      Duration
                    </p>
                    <p className="font-['Poppins'] font-medium text-[14px] leading-[21px] text-white">
                      24 Months
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3">
                  <div className="flex items-center justify-center w-[44px] h-[44px]">
                    <img
                      src="/src/assets/svg/chart-icon.svg"
                      alt="Course Level"
                      className="w-12 h-8"
                    />
                  </div>
                ...
                <div className="flex items-center gap-3">
                  <div className="flex items-center justify-center w-[44px] h-[44px]">
                    <img
                      src="/src/assets/svg/star-icon.svg"
                      alt="Credits"
                      className="w-11 h-11"
                    />
                  </div>
                ...
                <div className="flex items-center gap-3">
                  <div className="flex items-center justify-center w-[44px] h-[44px]">
                    <img
                      src="/src/assets/svg/module-icon.svg"
                      alt="Modules"
                      className="w-11 h-11"
                    />
                  </div>
          ...
          <div className="page-content px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
              <div className="flex-1">
                <div className="flex flex-col sm:flex-row gap-8 sm:gap-[100px] mb-12">
                  <div className="flex items-start gap-4 group">
                    <div className="flex flex-col items-end transition-transform duration-300 ease-in group-hover:translate-x-2">
                      <button className="flex items-center gap-2">
                        <span className="text-[#0C2D46] text-[16px] font-medium leading-[24px] font-['Poppins']">
                          Get Brochure
                        </span>
                      </button>
                      <div className="w-[150px] h-[5px] bg-[#0C2D46] rounded-full mt-1 transition-colors duration-300 group-hover:bg-[#ECA22D]"></div>
                    </div>

                    {/* Icon with overlay SVG */}
                    <div className="relative w-11 h-11">
                      <img
                        src="/src/assets/svg/document-icon.svg"
                        alt="Get Brochure"
                  ...
                  <div className="relative flex items-center group">
                    <button className="flex flex-col items-end transition-transform duration-300 ease-in group-hover:translate-x-2">
                      <span className="text-[#0C2D46] text-[16px] font-medium leading-[24px] font-['Poppins'] mb-1">
                        Apply Now
                      </span>
                      <div className="w-[150px] h-[5px] bg-[#0C2D46] rounded-full transition-colors duration-300 group-hover:bg-[#ECA22D]"></div>
                    </button>
                  </div>
                </div>
                ...
                <div>
                  ...
                  >
                    <p className="mb-6">
                      The Higher National Diploma International (HND) in
                      Computing with a specialization in Software Engineering is
                      a comprehensive program designed to equip students with
                      the knowledge, skills, and practical experience needed to
                      excel in the dynamic field of software development. This
                      program focuses on preparing students for careers in
                      designing, building, and maintaining software applications
                      that meet modern technological and business demands.
                    </p>
                    <p className="mb-8">
                      The Higher National Diploma International in Computing
                      with a specialization in Software Engineering offers a
                      comprehensive education in the ever-evolving field of
                      software development. Through a blend of theoretical
                      knowledge and hands-on experience, students are prepared
                      to contribute effectively to the creation of innovative
                      and practical software solutions, meeting the demands of
                      modern technology-driven industries. This program serves
                      as a gateway for those seeking to build a successful
              ...
              <div className="relative flex flex-col items-center lg:items-end w-full lg:w-1/3">
                ...
                >
                  <img
                    src="/src/assets/svg/form-background.svg"
                    alt="Form Background"
                    className="w-full h-full"
                  />
                </div>
                ...
                <div
                  className="relative z-30 font-poppins"
                  style={{ width: "262px" }}
                >
                  <h3
                    className="text-[36px] font-light leading-[54px] text-left mb-1 font-poppins"
                    style={{ marginLeft: "20px" }}
                  >
                    <span className="font-medium text-demont-orange">Talk</span>{" "}
                    to Our
                  </h3>
                  <p
                    className="text-[24px] font-light text-left mb-6 font-poppins"
                    style={{ marginLeft: "20px" }}
                  >
                    Admission Team
                  </p>
                  <div className="p-6">
                    <form className="relative z-10 space-y-8">
                      <div>
                        <label className="block mb-1 text-sm font-semibold font-poppins">
                          Name
                        </label>
                        <input
                          type="text"
                          placeholder="Enter your First & Last Names"
                          className="w-full px-0 py-2 text-sm bg-transparent border-0 border-b border-gray-400 rounded-none font-poppins focus:outline-none focus:border-demont-orange"
                        />
                      </div>
                      <div>
                        <label className="block mb-1 text-sm font-semibold font-poppins">
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-2 pb-2 border-b border-gray-400 focus-within:border-demont-orange">
                          <button disabled className="flex items-center gap-1">
                            <img
                              src="/src/assets/svg/uae-flag.svg"
                              alt="UAE Flag"
                              className="w-6 h-3"
                            />
                            <img
                              src="/src/assets/svg/chevron-down.svg"
                              alt="Dropdown"
                              className="w-2 h-1"
                            />
                          </button>
                      ...
                      <div className="pt-4" style={{ marginRight: "-50px" }}>
                        <button
                          ...
                          className="flex items-center gap-2 text-sm font-semibold text-white bg-demont-orange hover:bg-[#879DA5] font-poppins transition-all duration-300 ease-in-out group"
                          style={{
                        ...
                        >
                          ...
                          <img
                            ...
                            alt="Right Arrow"
                            className="w-1.5 h-2.5 transition-all duration-300 ease-in-out group-hover:translate-x-3 group-hover:brightness-0 group-hover:invert"
                          />
                        </button>
                      </div>
                    </form>
        ...
        <section
          className="relative py-20 page-container page-boundaries bg-demont-bg-gray"
          style={{ marginTop: "-40px" }}
        >
          <div className="page-content">
            <h2
              className="mb-12 text-center font-poppins"
              style={{
                fontFamily: "Poppins",
                fontStyle: "normal",
                fontWeight: "500",
            ...
            >
              Top <span className="text-demont-orange">Skills</span> you will
              Learn
            </h2>
            ...
            <div className="flex flex-col max-w-6xl gap-8 md:gap-12 mx-auto px-4">
              ...
              <div
                className="flex items-center justify-start gap-24"
        ...
        <section
          className="relative bg-white page-container page-boundaries"
          style={{ minHeight: "400px" }}
        >
          <div
            className="relative h-full page-content"
            style={{
              paddingTop: "60px",
              paddingBottom: "60px",
              overflow: "visible",
            ...
            <div className="relative z-10 h-full">
              <div className="flex h-full gap-12">
                <div className="relative flex-1">
                  ...
                  >
                    <span className="text-demont-orange">Job</span>{" "}
                    Opportunities
                  </h2>

                  <div
                    className="relative z-10 prose max-w-none font-poppins"
                    style={{
                      width: "814px",
                      fontFamily: "Poppins",
                      fontStyle: "normal",
                  ...
                  >
                    <p>
                      Graduates of the Higher National Diploma International
                      (HND) in Computing (Software Engineering) are
                      well-equipped to pursue a wide range of job opportunities
                      in the dynamic field of software development. The skills
                      gained through this program open doors to various roles
                      across industries that rely on technology and software
                      solutions.
                    </p>
                  </div>
        ...
        <section
          className="relative py-20 page-container page-boundaries"
          style={{ backgroundColor: "#0C2D46" }}
        >
          <div className="page-content">
            <h2
            ...
            >
              <span className="text-demont-orange">Who</span> Is This Programme
              for?
            </h2>
            ...
            >
              <p>
                ...
                with a specialization in Software Engineering is designed for a
                diverse range of individuals who are interested in pursuing a
                career in the field of software development. This program caters
                to various backgrounds and aspirations, making it suitable for
                High School Graduates, Tech Enthusiasts, and IT Professionals
                etc.
              </p>
            </div>
          </div>
          ...
          <div className="page-content">
            ...
            >
              ...
              >
                ...
                Students must be&nbsp;
                <span style={{ fontWeight: "500" }}>
                  <strong>High School Graduates</strong>
                </span>
              </li>
            </ul>
            ...
            >
              <p>
                ...
                appraisal service for educational institutions and corporations,
                as for students directly. It integrates world-class educational
                content and evaluation, driven by services and technology, to
                allow more efficient teaching and customized learning. Their
                mission is to have a direct partnership with millions of
                lifelong learners and to link education to the way people aspire
                to live and work each day. They assume that wherever learning
              ...
              <div style={{ flex: 1, marginLeft: "60px" }}>
                ...
                >
                  ...
                  >
                    ...
                    ></div>
                    Gain the essential knowledge, understanding, and skills
                    required for a successful career in the computing industry,
                    equipping you with a solid foundation to excel in various
                    roles.
                  </li>
                  <li
                    style={{
                  ...
                  >
                    ...
                    ></div>
                    Develop a versatile skill set through the effective
                    integration of knowledge and skills gained across different
                    program components, enabling you to tackle multifaceted
                    challenges in the computing industry.
                  </li>
                  <li
                    style={{
                      display: "flex",
                  ...
                  >
                    ...
                    ></div>
                    Gain flexibility, knowledge, skills, and motivation that
                    serve as a solid foundation for ongoing studies and career
                    advancement in the dynamic realm of computing
                  </li>
                </ul>
              </div>
            </div>
        ...
        <section className="relative py-20 bg-white page-container page-boundaries">
          <div className="page-content">
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    Higher National Diploma International in Computing (Cyber
                    Security)
                  </div>
                </div>
                <div
                ...
                <div
                  style={{
                    ...
                    top: "172px",
                    background:
                      "linear-gradient(180deg, #F5F5F5 0%, rgba(247, 247, 247, 0.81) 38.68%, rgba(255, 255, 255, 0) 100%)",
                    borderRadius: "0px",
                  }}
                ></div>
              ...
              >
                ...
                <div
                  style={{
                    ...
                    top: "172px",
                    background:
                      "linear-gradient(180deg, #F5F5F5 0%, rgba(247, 247, 247, 0.95) 38.68%, rgba(255, 255, 255, 0) 100%)",
                    borderRadius: "0px",
                  }}
                ></div>
            ...
            >
              <span>
                Explore <span style={{ fontWeight: "bold" }}>All Programs</span>
              </span>
              <div
                style={{
                  position: "relative",
              ...
              >
                ...
                >
                  <path
                    d="M22 5L1 5M22 5L18 9M22 5L18 1"
                    stroke="black"
                    strokeWidth="2"
                    strokeLinecap="round"
                    strokeLinejoin="round"
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <span style={{ color: "#ECA22D" }}>Partners</span>
                </h2>
                <p
                  style={{
                    fontFamily: "Poppins",
                ...
                >
                  <span style={{ fontWeight: "bold" }}>DeMont</span> Institute
                  of Management and Technology proudly collaborates with top
                  institutions globally, ensuring our students receive
                    ...
                    <defs>
                      ...
                      >
                        ...
                        <feBlend
                          ...
                          result="effect1_dropShadow_645_7256"
                        />
                        <feBlend
                          mode="normal"
                          in="SourceGraphic"
                          in2="effect1_dropShadow_645_7256"
                          result="shape"
                        />
                      </filter>
                    </defs>
                  ...
                  >
                    ...
                    >
                      <g filter="url(#filter0_d_5341_82)">
                        <path
                          d="M4 3H58C71.8071 3 83 14.1929 83 28V35C83 48.8071 71.8071 60 58 60H4V3Z"
                          fill="#879DA5"
                          className="group-hover:fill-[#0C2D46] transition-colors"
                        />
                      </g>
                      <defs>
                        <filter
                          id="filter0_d_5341_82"
                          x="0"
                          y="0"
                          width="87"
                          height="65"
                        ...
                        >
                          ...
                          <feBlend
                            mode="normal"
                            in2="BackgroundImageFix"
                            result="effect1_dropShadow_5341_82"
                          />
                          <feBlend
                            mode="normal"
                            in="SourceGraphic"
                            in2="effect1_dropShadow_5341_82"
                            result="shape"
                          />
                        </filter>
                      </defs>
              ...
              >
                <div style={{ width: "802px" }}>
                  <button
                    onClick={() => {
                      const content =
                        document.getElementById("course-content-1");
                      ...
                      if (
                        ...
                        icon.innerHTML =
                          '<svg width="19" height="20" viewBox="0 0 19 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M1.5 10L17.5 10" stroke="white" stroke-width="3" stroke-linecap="round"/></svg>';
                      } else {
                        content.style.display = "none";
                        icon.innerHTML =
                          '<svg width="19" height="20" viewBox="0 0 19 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M1.5 10L17.5 10M9.5 18V2" stroke="white" stroke-width="3" stroke-linecap="round"/></svg>';
                      }
                    }}
                    style={{
                      width: "100%",
                ...
                <div style={{ width: "802px" }}>
                  <button
                    onClick={() => {
                      const content =
                        document.getElementById("course-content-2");
                ...
                <div style={{ width: "802px" }}>
                  <button
                    onClick={() => {
                      const content =
                        document.getElementById("course-content-3");
                ...
                <div style={{ width: "802px" }}>
                  <button
                    onClick={() => {
                      const content =
                        document.getElementById("course-content-4");
                ...
                <div style={{ width: "802px" }}>
                  <button
                    onClick={() => {
                      const content =
                        document.getElementById("course-content-5");
                  ...
                  >
                    ...
                    >
                      <g filter="url(#filter0_d_645_7283)">
                        <path
                          d="M6 55C6 27.3858 28.3858 5 56 5H102V126H56C28.3858 126 6 103.614 6 76V55Z"
                          fill="#ECA22D"
                        />
                      </g>
                      <defs>
                        <filter
                          id="filter0_d_645_7283"
                          x="0"
                          y="0"
                          width="108"
                          height="133"
                        ...
                        >
                          ...
                          <feBlend
                            mode="normal"
                            in2="BackgroundImageFix"
                            result="effect1_dropShadow_645_7283"
                          />
                          <feBlend
                            mode="normal"
                            in="SourceGraphic"
                            in2="effect1_dropShadow_645_7283"
                            result="shape"
                          />
                        </filter>
                      </defs>
                  ...
                  >
                    ...
                    >
                      <g filter="url(#filter0_d_645_7286)">
                        <path
                          d="M6 55C6 27.3858 28.3858 5 56 5H58C85.6142 5 108 27.3858 108 55V127H9C7.34315 127 6 125.657 6 124V55Z"
                          fill="#0C2D46"
                        />
                      </g>
                      <defs>
                        <filter
                          id="filter0_d_645_7286"
                          x="0"
                          y="0"
                          width="114"
                          height="134"
                        ...
                        >
                          ...
                          <feBlend
                            mode="normal"
                            in2="BackgroundImageFix"
                            result="effect1_dropShadow_645_7286"
                          />
                          <feBlend
                            mode="normal"
                            in="SourceGraphic"
                            in2="effect1_dropShadow_645_7286"
                            result="shape"
                          />
                        </filter>
                      </defs>
                  ...
                  >
                    ...
                    >
                      <g filter="url(#filter0_d_645_7285)">
                        <path
                          d="M6 26C6 14.402 15.402 5 27 5V127H6V26Z"
                          fill="#ECA22D"
                        />
                      </g>
                      <defs>
                        <filter
                          id="filter0_d_645_7285"
                          x="0"
                          y="0"
                          width="33"
                          height="134"
                        ...
                        >
                          ...
                          <feBlend
                            mode="normal"
                            in2="BackgroundImageFix"
                            result="effect1_dropShadow_645_7285"
                          />
                          <feBlend
                            mode="normal"
                            in="SourceGraphic"
                            in2="effect1_dropShadow_645_7285"
                            result="shape"
                          />
                        </filter>
                      </defs>
                      ...
                      <defs>
                        ...
                        >
                          ...
                          <feBlend
                            mode="normal"
                            in2="BackgroundImageFix"
                            result="effect1_dropShadow_645_7295"
                          />
                          <feBlend
                            mode="normal"
                            in="SourceGraphic"
                            in2="effect1_dropShadow_645_7295"
                            result="shape"
                          />
                        </filter>
                      </defs>
                  ...
                  >
                    ...
                    >
                      <g filter="url(#filter0_d_645_7291)">
                        <path
                          d="M6 110C6 118.837 13.1634 126 22 126C30.8366 126 38 118.837 38 110V21C38 12.1634 30.8366 5 22 5C13.1634 5 6 12.1634 6 21V110Z"
                          fill="#0C2D46"
                        />
                      </g>
                      <defs>
                        <filter
                          id="filter0_d_645_7291"
                          x="0"
                          y="0"
                          width="44"
                          height="133"
                        ...
                        >
                          ...
                          <feBlend
                            mode="normal"
                            in2="BackgroundImageFix"
                            result="effect1_dropShadow_645_7291"
                          />
                          <feBlend
                            mode="normal"
                            in="SourceGraphic"
                            in2="effect1_dropShadow_645_7291"
                            result="shape"
                          />
                        </filter>
                      </defs>
              ...
              >
                ...
                >
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                    d="M21.2983 6.20672C21.3365 2.77965 24.1788 0.0056962 27.6575 8.42128e-06C31.2507 -0.00566247 34.1711 2.85348 34.1695 6.37548C34.1687 9.81229 31.0996 12.828 27.625 12.807C24.139 12.7858 21.2584 9.78146 21.2983 6.20672Z"
                    fill="#ECA22D"
                  />
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                    d="M34.1631 62.1682H34.1656C34.1582 45.9326 34.1509 29.6978 34.1444 13.4639C29.3242 16.0804 24.7843 19.1886 19.4912 21.29C19.4912 21.29 22.1492 23.0344 22.2507 28.7299C22.4287 29.3043 22.2735 29.9266 22.2743 30.5132C22.2759 31.3781 22.2767 32.2438 22.2784 33.1095H22.2572V56.8816C22.2507 57.9209 22.2548 58.9602 22.2458 59.9987C22.245 60.1513 22.2507 60.2859 22.2572 60.4214V63.2757C22.2515 64.0773 22.2524 64.8773 22.2458 65.6781C22.232 67.3802 22.6001 68.0317 24.4455 67.9352C27.6787 67.7673 30.925 67.863 34.1656 67.8476C34.1647 65.9539 34.1639 64.0611 34.1631 62.1682Z"
                    fill="#0C2D46"
                  />
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                    d="M110.405 68.3864H111.274V6.75342H110.405V68.3864Z"
                    fill="#ECA22D"
                  />
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                    d="M64.7255 21.2808C60.6025 21.2808 56.5583 22.8645 53.1495 26.823C51.8803 22.9432 48.9469 21.2808 45.4577 21.2808C41.771 21.2808 38.1591 22.6235 34.9819 25.8015V30.9154C36.7363 29.4111 38.7304 28.4854 40.3035 28.4854C42.4446 28.4854 43.7139 29.5937 43.7139 33.0776V67.8327H53.9426V32.048V31.1766C55.6864 29.5142 57.9064 28.4854 59.5714 28.4854C61.6329 28.4854 62.9021 29.5937 62.9021 33.0776V67.8327H73.2097V32.048C73.2097 24.8433 69.6416 21.2808 64.7255 21.2808Z"
                    fill="#0C2D46"
                  />
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                    d="M17.2873 67.9442C11.4497 67.9247 6.52143 65.8193 3.05822 60.9529C-0.604064 55.8075 -1.00629 50.2125 2.00919 44.6516C5.25625 38.664 10.5299 35.9695 17.245 36.0052C10.9158 46.6832 10.9451 57.1867 17.2873 67.9442Z"
                    fill="#0C2D46"
                  />
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                    d="M79.7932 29.1351H90.6557V29.118H97.5545V22.0716H90.6557V15.1696L79.7932 8.90771V22.0716H75.1948V29.118H79.7932V29.1351Z"
                    fill="#0C2D46"
                  />
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                    d="M94.779 59.8364C92.0041 59.8364 90.656 58.5691 90.656 55.482V35.0518H79.7935V56.432C79.7935 63.8744 82.41 68.3862 91.211 68.3862C93.9071 68.3862 96.2855 68.1485 98.1098 67.8321V59.5192C97.0786 59.7569 95.889 59.8364 94.779 59.8364Z"
                    fill="#0C2D46"
                  />
                  <circle
        ...
        {isPopupOpen && (
          ...
          >
            <div
              className={`bg-white rounded-[25px] shadow-lg relative ${
            ...
            >
              ...
              <div className="text-center mb-8">
                <h2
                  className="text-demont-orange font-light"
                  style={{ fontSize: "55px" }}
                >
                  Thank you
                </h2>
                ...
                <p
                  className="text-black text-center mt-16 px-16 mx-2 leading-relaxed"
                  style={{ fontSize: "18px" }}
                >
                  Your inquiry has been successfully submitted. Our Academic
                  Advisor shall get in touch with you within the next 48 hours.
                </p>
                <p
                  className="text-black text-center mt-16 px-16 mx-2"
                  style={{ fontSize: "18px" }}
                >
                ...
                <div className="flex justify-center gap-2 mt-8 px-8">
                  <button
                    className="bg-demont-orange text-white font-medium flex items-center justify-center gap-2"
                    style={{
                      width: "257px",
                      height: "48px",
                      borderRadius: "5px",
                  ...
                  <button
                    className="bg-[#0C2D46] text-white font-medium flex items-center justify-center gap-2"
                    style={{
                      width: "257px",
                      height: "48px",
                      borderRadius: "5px",
                  ...
                  >
                    ...
                    >
                      <path
                        d="M24.1667 20H2.5C1.11667 20 0 18.8833 0 17.5V2.5C0 1.11667 1.11667 0 2.5 0H24.1667C25.55 0 26.6667 1.11667 26.6667 2.5V17.5C26.6667 18.8833 25.55 20 24.1667 20ZM2.5 1.66667C2.03333 1.66667 1.66667 2.03333 1.66667 2.5V17.5C1.66667 17.9667 2.03333 18.3333 2.5 18.3333H24.1667C24.6333 18.3333 25 17.9667 25 17.5V2.5C25 2.03333 24.6333 1.66667 24.1667 1.66667H2.5Z"
                        fill="white"
                      />
                      <path
                        d="M13.3333 13.2669C12.1666 13.2669 11.1 12.8003 10.3 11.9503L1.54995 2.65028C1.23329 2.31695 1.24995 1.78361 1.58329 1.46695C1.91662 1.15028 2.44995 1.16695 2.76662 1.50028L11.5166 10.8003C12.4666 11.8169 14.2 11.8169 15.15 10.8003L23.9 1.51695C24.2166 1.18361 24.75 1.16695 25.0833 1.48361C25.4166 1.80028 25.4333 2.33361 25.1166 2.66695L16.3666 11.9669C15.5666 12.8169 14.5 13.2836 13.3333 13.2836V13.2669Z"
                        fill="white"
                      />
                    </svg>
                ...
                <div className="flex justify-center gap-4 mt-24">
                  <a
                    href="#"
                    className="flex items-center justify-center transition-colors rounded-full hover:bg-demont-orange"
                  ...
                  >
                    ...
                    >
                      ...
                      />
                      <path
                        d="M7.50237 8.15967L16.0342 19.567L7.44922 28.842H9.38192L16.8989 20.722L22.9718 28.842H29.5476L20.5361 16.793L28.5275 8.15967L26.5947 8.15967L19.6728 15.638L14.0795 8.15967L7.50365 8.15967H7.50237ZM10.3437 9.58299L13.364 9.58299L26.7036 27.4186H23.6834L10.3437 9.58299Z"
                        fill="white"
                      />
                    </svg>
                  </a>
                  ...
                  >
                    ...
                    >
                      ...
                      />
                      <path
                        d="M24.225 7.52734L12.7761 7.52734C9.61317 7.52734 7.04004 10.1005 7.04004 13.2634L7.04004 23.7374C7.04004 26.9004 9.61317 29.4735 12.7761 29.4735H24.225C27.3879 29.4735 29.961 26.9004 29.961 23.7374V13.2634C29.961 10.1005 27.3879 7.52734 24.225 7.52734ZM9.06355 13.2634C9.06355 11.2166 10.7293 9.55085 12.7761 9.55085L24.225 9.55085C26.2718 9.55085 27.9375 11.2166 27.9375 13.2634V23.7374C27.9375 25.7843 26.2718 27.45 24.225 27.45H12.7761C10.7293 27.45 9.06355 25.7843 9.06355 23.7374L9.06355 13.2634Z"
                        fill="white"
                      />
                      <path
                        d="M18.5006 23.8351C21.4419 23.8351 23.8361 21.4422 23.8361 18.4996C23.8361 15.557 21.4432 13.1641 18.5006 13.1641C15.558 13.1641 13.165 15.557 13.165 18.4996C13.165 21.4422 15.558 23.8351 18.5006 23.8351ZM18.5006 15.1889C20.327 15.1889 21.8126 16.6744 21.8126 18.5009C21.8126 20.3274 20.327 21.8129 18.5006 21.8129C16.6741 21.8129 15.1886 20.3274 15.1886 18.5009C15.1886 16.6744 16.6741 15.1889 18.5006 15.1889Z"
                        fill="white"
                      />
                      <path
                        d="M24.3302 14.0256C25.1222 14.0256 25.7677 13.3813 25.7677 12.588C25.7677 11.7947 25.1235 11.1504 24.3302 11.1504C23.5368 11.1504 22.8926 11.7947 22.8926 12.588C22.8926 13.3813 23.5368 14.0256 24.3302 14.0256Z"
                        fill="white"
                      />
                    </svg>
                  </a>
                  ...
                  >
                    ...
                    >
                      ...
                      />
                      <path
                        d="M8.82355 12.2984C8.33614 11.846 8.09375 11.286 8.09375 10.6197C8.09375 9.95343 8.33744 9.3688 8.82355 8.91509C9.31095 8.46269 9.93836 8.23584 10.7071 8.23584C11.4758 8.23584 12.0785 8.46269 12.5647 8.91509C13.0521 9.3675 13.2945 9.93657 13.2945 10.6197C13.2945 11.3029 13.0508 11.846 12.5647 12.2984C12.0773 12.7508 11.4589 12.9777 10.7071 12.9777C9.95521 12.9777 9.31095 12.7508 8.82355 12.2984ZM12.8848 14.8936L12.8848 28.7639H8.50207L8.50207 14.8936H12.8848Z"
                        fill="white"
                      />
                      <path
                        d="M27.4744 16.264C28.4298 17.3011 28.9069 18.7244 28.9069 20.5366V28.5192H24.7445V21.0992C24.7445 20.1853 24.5073 19.475 24.0341 18.9694C23.561 18.4638 22.9232 18.2098 22.1247 18.2098C21.3262 18.2098 20.6884 18.4625 20.2152 18.9694C19.7421 19.475 19.5049 20.1853 19.5049 21.0992V28.5192H15.3179L15.3179 14.855H19.5049V16.6672C19.9287 16.0631 20.5004 15.5861 21.2186 15.2348C21.9367 14.8835 22.7443 14.7085 23.6426 14.7085C25.2423 14.7085 26.5204 15.227 27.4744 16.2628V16.264Z"
                        fill="white"
                      />
                    </svg>
                  </a>
